...
<div class="ep-setting-tab-content">
    <?php $performers_text = $ep_functions->ep_global_settings_button_title('Performers'); ?>
    <?php $performer_text = $ep_functions->ep_global_settings_button_title('Performer'); ?>
...
<table class="form-table">
    <tbody>
            ...
            <td class="forminp forminp-text">
                <select name="performer_display_view" id="ep_settings_front_display_view" class="ep-form-control">
                    ...
                    foreach( $sub_options['front_view_list_styles'] as $key => $view_name ){ ?>
                        <option value="<?php echo esc_attr( $key );?>" <?php if( $global_options->performer_display_view == $key ) { echo 'selected="selected"'; } ?>>
        ...
        <tr valign="top" id="ep_settings_card_background" <?php if( $global_options->performer_display_view != 'box' && $global_options->performer_display_view != 'colored_grid' ) { echo 'style="display:none;"'; } ?>>
            <th scope="row" class="titledesc">
            ...
            <td class="forminp forminp-text">
                <?php foreach( $global_options->performer_box_color as $key => $color ){?>
                    <input type="text" data-jscolor="{}" name="performer_box_color[<?php echo esc_attr($key);?>]" id="performer_box_color_<?php echo esc_attr($key);?>" value="<?php echo esc_attr( $global_options->performer_box_color[$key] );?>"><?php
                }?>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <input type="number" min="0"  name="performer_limit" id="performer_limit" class="ep-form-control" value="<?php echo esc_attr( $global_options->performer_limit );?>">
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <select name="performer_no_of_columns" id="performer_no_of_columns" class="ep-form-control">
                    <option value="1" <?php if( $global_options->performer_no_of_columns == 1 ){ echo 'selected'; } ?> >1</option>
                    <option value="2" <?php if( $global_options->performer_no_of_columns == 2 ){ echo 'selected'; } ?> >2</option>
                    <option value="3" <?php if( $global_options->performer_no_of_columns == 3 ){ echo 'selected'; } ?> >3</option>
                    <option value="4" <?php if( $global_options->performer_no_of_columns == 4 ){ echo 'selected'; } ?>>4</option>
                </select> 
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="performer_load_more" id="performer_load_more" <?php if( esc_attr( $global_options->performer_load_more == 1 ) ){ echo 'checked="checked"'; }?>>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="performer_search" id="performer_search" <?php if( esc_attr( $global_options->performer_search == 1 ) ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
...
<table class="form-table">
    <tbody>
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="single_performer_show_events" onclick="ep_frontend_view_child_hide_show(this,'ep_frontend_view_child')" id="single_performer_show_events" <?php if( esc_attr( $global_options->single_performer_show_events == 1 ) ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
...
<table id="ep_frontend_view_child" class="form-table" style="<?php if( esc_attr( $global_options->single_performer_show_events == 1 ) ){ echo 'display:block;"'; }else{ echo 'display:none;';}?>">
    <tbody>
        <tr valign="top">
            <th scope="row" class="titledesc">
            ...
            <td class="forminp forminp-text">
                <select name="single_performer_event_display_view" class="ep-form-control">
                    ...
                    foreach( $sub_options['front_view_event_styles'] as $key => $view_name ){ ?>
                        <option value="<?php echo esc_attr( $key );?>" <?php if( $global_options->single_performer_event_display_view == $key ) { echo 'selected="selected"'; } ?>>
                            <?php echo esc_html( $view_name );?>
                        </option><?php
                    }?>
                </select>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <input type="number" min="0" name="single_performer_event_limit" id="single_performer_event_limit" class="ep-form-control" value="<?php echo esc_attr( $global_options->single_performer_event_limit );?>">
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <select name="single_performer_event_column" id="single_performer_event_column" class="ep-form-control">
                    <option value="1" <?php if( $global_options->single_performer_event_column == 1 ){ echo 'selected'; } ?> >1</option>
                    <option value="2" <?php if( $global_options->single_performer_event_column == 2 ){ echo 'selected'; } ?> >2</option>
                    <option value="3" <?php if( $global_options->single_performer_event_column == 3 ){ echo 'selected'; } ?> >3</option>
                    <option value="4" <?php if( $global_options->single_performer_event_column == 4 ){ echo 'selected'; } ?>>4</option>
                </select> 
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="single_performer_event_load_more" id="single_performer_event_load_more" <?php if( esc_attr( $global_options->single_performer_event_load_more == 1 ) ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="single_performer_hide_past_events" id="single_performer_hide_past_events" <?php if( esc_attr( $global_options->single_performer_hide_past_events == 1 ) ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
        ...
        <tr valign="top">
            <th scope="row" class="titledesc">
                <label for="single_performer_event_section_title">
                    <?php esc_html_e( 'Events Section Title', 'eventprime-event-calendar-management' );?>
                </label>
            </th>
            <td class="forminp forminp-text">
                    <input name="single_performer_event_section_title" id="single_performer_event_section_title" type="text" value="<?php echo isset( $global_options->single_performer_event_section_title ) && ! empty( $global_options->single_performer_event_section_title ) ? esc_attr( $global_options->single_performer_event_section_title ) : esc_attr__("Upcoming Events", "eventprime-event-calendar-management"); ?>">
