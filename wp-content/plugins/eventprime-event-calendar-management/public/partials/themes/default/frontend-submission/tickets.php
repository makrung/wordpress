            ...
            <div class="ep-box-row ep-border ep-bg-light ep-rounded ep-p-3">
                ...
                <div class="ep-box-col-12">
                    ...
                    <div class="ep-form-check ep-form-check-inline ep-mb-3">
                        <input class="ep-form-check-input" type="radio" name="em_enable_booking" id="ep-bookings-on" value="bookings_on" <?php echo ( (isset($args->event->em_enable_booking) && $args->event->em_enable_booking == 'bookings_on') || (isset( $args->fes_event_booking_req ) && ! empty( $args->fes_event_booking_req )) ) ? 'checked="checked"' : '';?>>
    ...
    <div class="ep-fes-section ep-mb-4 ep-border ep-p-4 ep-shadow-sm ep-rounded-1" id="ep-bookings-url" style="<?php if(isset($args->event) && $args->event->em_enable_booking == 'external_bookings') {echo 'display:block;';}else{ echo 'display: none;';} ?>">
        <div class="ep-box-row ep-p-3">
            <div class="ep-box-col-12">
                ...
                <input type="url" class="ep-form-control ep-box-w-50" name="em_custom_link" id="ep_event_custom_link" value="<?php if(isset($args->event) && isset($args->event->em_custom_link)){ echo esc_attr( $args->event->em_custom_link ); }?>">
                <div class="ep-text-muted ep-text-small">
            ...
            <div class="ep-box-col-12 ep-mt-3">
                <div class="ep-form-check ep-form-check-inline ">
                    <input class="ep-form-check-input" name="em_custom_link_new_browser" type="checkbox" value="1" id="flex-check-default" <?php if( isset($args->event) && isset($args->event->em_custom_link_new_browser) && $args->event->em_custom_link_new_browser == 1 ) { echo 'checked="checked"';} ?> >
