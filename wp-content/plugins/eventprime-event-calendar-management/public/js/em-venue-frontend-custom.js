jQuery( function( $ ) {
    ...
    $(document).on( 'click', '#ep_venue_search_form input[type="submit"]', function(ev) {
        if ( $('#ep_keyword').val() == '' ) {
            ev.preventDefault();
            $('#ep_keyword').focus(); 
        }
    ...
    $(document).on('click','#ep-loadmore-ep-venues',function(e){
        var max_page = $('#ep-loadmore-ep-venues').data('max');
        ...
        $('#ep-loadmore-ep-venues').prop("disabled", true);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#ep-loadmore-ep-venues').prop("disabled", false);
    ...
    $( document ).on( 'click', '#ep-loadmore-upcoming-event-venue', function(e) {
        ...
        $('.ep-spinner').addClass('ep-is-active');
        $('#ep-loadmore-upcoming-event-venue').prop('disabled', true);
        $('.ep-register-response').html();
        $.ajax({
            type : "POST",
            url : ep_frontend.ajaxurl,
            ...
            success: function(response) {
                $('.ep-spinner').removeClass('ep-is-active');
                $('#ep-loadmore-upcoming-event-venue').prop('disabled', false);
